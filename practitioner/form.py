...
class PractitionerForm(forms.Form):
	...
	services = forms.CharField(max_length=800, widget=forms.Textarea(attrs={'rows':'1'}), label="Services offered", required=False)
	...
	start_time = forms.ChoiceField(choices = TIME, label = "Start time.", initial='20', required = True)
	end_time = forms.ChoiceField(choices = TIME, label = "End time.", initial='28', required = True)
