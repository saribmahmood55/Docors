...
class PracticeForm(forms.Form):
    ...
    def save(self,practitioner,extraTimings):
        ...
        pt = PracticeTiming(practice=practice, day=day, start_time=start_time, end_time=end_time)
        pt.save()

        #Extra Timings
        for key,day in enumerate(extraTimings["day"]):
            pt = PracticeTiming(practice=practice, day=int(day), start_time=extraTimings["start_time"][key], end_time=extraTimings["end_time"][key])
            pt.save()
